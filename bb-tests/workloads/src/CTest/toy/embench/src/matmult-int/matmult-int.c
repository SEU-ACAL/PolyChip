...
/* This scale factor will be changed to equalise the runtime of the
   benchmarks. */
// #define LOCAL_SCALE_FACTOR 46  // Original value for FPGA/real hardware
...
int values_match(long v1, long v2) { return (v1 == v2); }
...
int verify_benchmark(int unused) {
  int i, j;
  matrix exp = {{291018000, 315000075, 279049970, 205074215, 382719905,
  ...
  return 0 ==
         memcmp(ResultArray, exp, UPPERLIMIT * UPPERLIMIT * sizeof(exp[0][0]));
}
