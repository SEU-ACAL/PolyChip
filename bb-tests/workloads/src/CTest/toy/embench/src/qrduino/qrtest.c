...
/* This scale factor will be changed to equalise the runtime of the
   benchmarks. */
// #define LOCAL_SCALE_FACTOR 5  // Original value for FPGA/real hardware
...
int verify_benchmark(int unused) {
  unsigned char expected[22] = {254, 101, 63,  128, 130, 110, 160, 128,
                                186, 65,  46,  128, 186, 38,  46,  128,
                                186, 9,   174, 128, 130, 20};
